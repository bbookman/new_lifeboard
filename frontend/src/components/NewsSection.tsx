  ...
  const renderLLMContent = () => {
    ...
    return (
      <div className="prose prose-sm max-w-none">
        <div className="whitespace-pre-wrap text-newspaper-body leading-relaxed">{llmSummary.content}</div>
      ...
      <div className="space-y-6">
        ...
        <Card className="overflow-hidden hover:shadow-lg transition-shadow border-l-4 border-l-news-accent">
          <div className="aspect-[16/9] relative overflow-hidden">
            <img src={newsImage} alt="Daily AI Summary" className="w-full h-full object-cover" />
            <div className="absolute top-4 left-4">
              <Badge className="bg-news-accent text-white font-bold">AI SUMMARY</Badge>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <span className="text-newspaper-byline text-xs">Generated by AI</span>
            </div>
            {renderLLMContent()}
          </div>
        </Card>
