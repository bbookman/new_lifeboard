        ...
        setMessages([
          {
            id: 'welcome',
            content:
              'Welcome to your personal Lifeboard assistant! I can help you explore your digital history, find connections, and plan your next steps. What would you like to know about your data?',
            isUser: false,
            timestamp: new Date(),
          },
        ]);
      ...
      <div className="chat-container">
        ...
        <div className="card chat-messages-container">
          <div className="chat-messages">
            {loadingHistory && (
              <div style={{ textAlign: 'center', padding: '2rem', color: '#666' }}>Loading chat history...</div>
            )}
                ...
                <div key={message.id} className={`chat-message ${message.isUser ? 'user' : 'assistant'}`}>
                  <div className="chat-message-content">
                    <div className="message-header">
                      <span className="message-sender">{message.isUser ? 'You' : 'Lifeboard AI'}</span>
              ...
              <div className="card-content">
                <div className="sample-questions">
                  {sampleQuestions.map((question, index) => (
                    <button key={index} onClick={() => setInputValue(question)} className="sample-question">
                      {question}
                    </button>
                  ))}
                </div>
