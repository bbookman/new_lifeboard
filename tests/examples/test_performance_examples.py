...
class TestDatabasePerformanceExamples:
    ...
    @pytest.mark.asyncio
    async def test_bulk_insert_performance(self, temp_database):
    ...
    @pytest.mark.asyncio
    async def test_query_performance_with_index(self, temp_database):
...
class TestAPIPerformanceExamples:
    ...
    @pytest.mark.asyncio
    async def test_api_throughput_under_load(self):
...
class TestPerformanceTestUtilities:
    ...
    @pytest.mark.asyncio
    async def test_performance_utilities(self):
