...
class LimitlessSource(BaseSource, HTTPClientMixin):
    ...
    def _create_client_config(self) -> Dict[str, Any]:
        ...
        logger.debug("[AUTH DEBUG] Creating HTTP client with:")
